...
export default function StressTestPage() {
    ...
    (candidate: DecisionCandidate) => {
      ...
      setSessionDecisions((prev) => {
        ...
        const sessionDecision: SessionDecision = {
          ...
          urgency: candidate.scores.urgency,
          ...
          excerpt: candidate.evidence.full || undefined,
          sourceType: "intake",
          createdAt: Date.now(),
        };
        added = true;
  ...
  const handleFileSelected = useCallback((fileName: string | null) => {
